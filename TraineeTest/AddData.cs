...
{
    public partial class AddData : Form, IAddData
    {
        ...
        private AddDataPresenter addDataPresenter;
        ...
        private void btnAddData_MouseClick(object sender, MouseEventArgs e)
        {
            ...
            addDataPresenter = new AddDataPresenter(this);
            if (!addDataPresenter.AddDataBarang())
            {
        ...
        {
            btnAddData.Enabled = !string.IsNullOrEmpty(tbNamaBarang.Text) && !string.IsNullOrEmpty(tbHargaBarang.Text);
        }
